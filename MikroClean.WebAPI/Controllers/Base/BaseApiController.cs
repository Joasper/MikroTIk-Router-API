...
namespace MikroClean.WebAPI.Controllers.Base
{
    ...
    {
        /// <summary>
        /// Convierte ApiResponse en IActionResult con el c�digo HTTP apropiado
        /// </summary>
        ...
        /// </summary>
        protected IActionResult HandleValidationError(string message = "Datos de entrada inv�lidos")
        {
