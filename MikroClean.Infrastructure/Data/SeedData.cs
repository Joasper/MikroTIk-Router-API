...
namespace MikroClean.Infrastructure.Data
{
    public static class SeedData
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            // Username: superadmin
            // Password: Admin123!
            // IMPORTANTE: Cambiar esta contrase�a despu�s del primer acceso
            ...
            modelBuilder.Entity<SystemPermission>().HasData(
                ...
                new SystemPermission { Id = 9, Name = "VIEW_AUDIT_LOGS", Description = "Ver logs de auditor�a", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
                new SystemPermission { Id = 10, Name = "MANAGE_BILLING", Description = "Gestionar facturaci�n", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
            );
            ...
            modelBuilder.Entity<RouterRole>().HasData(
                ...
                new RouterRole { Id = 3, Name = "Viewer", Description = "Solo visualizaci�n", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
                new RouterRole { Id = 4, Name = "Technician", Description = "T�cnico de soporte", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
            );
            ...
            modelBuilder.Entity<RouterPermission>().HasData(
                ...
                new RouterPermission { Id = 9, Name = "VIEW_STATISTICS", Description = "Ver estad�sticas", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
                new RouterPermission { Id = 10, Name = "BACKUP_CONFIG", Description = "Backup de configuraci�n", CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
            );
